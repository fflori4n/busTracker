...
Widget busListItem(BuildContext context, Bus bus, Size constraints) {
 try{
   //, //Station station){
   ...
   try{
      time2Station = getEstTime2Station(selectedStations.elementAt(bus.stationNumber).distFromLineStart[bus.stationNumber]).toDouble();
   }
   catch(E){
     print("[  Wr  ] " + E.toString());
   }
